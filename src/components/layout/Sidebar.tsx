...
import { LayoutDashboard, Package, ShoppingCart, Factory, Menu, X, Layers, LogOut, Users } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/sales-ledger', label: 'Vendas', icon: ShoppingCart },
]
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-border">
          ...
          <span className="font-semibold text-sm text-foreground tracking-wide">Print3D</span>
        </div>
