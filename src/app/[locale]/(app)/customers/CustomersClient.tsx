...
export function CustomersClient({
  ...
  const editFields = [
    { key: "name", label: c.edit.name.value, placeholder: "" },
    {
      key: "email",
      label: c.edit.email.value,
      placeholder: "email@exemplo.com",
    },
    { key: "phone", label: c.edit.phone.value, placeholder: "9XX XXX XXX" },
    { key: "nif", label: c.edit.nif.value, placeholder: "123456789" },
  ];
      ...
      {filtered.length === 0 ? (
        <div className="border border-dashed rounded-lg py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {search ? c.emptySearch : c.emptyList}
          </p>
        </div>
      ) : (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-end gap-2 pt-1">
                        <Button
                          ...
                          disabled={saving}
                        >
                          <X size={13} className="mr-1" /> {c.edit.cancel}
                        </Button>
                        <Button
                          size="sm"
                        ...
                        >
                          ...
                          {saving ? c.edit.saving : c.edit.save}
                        </Button>
                      </div>
                    </div>
                  ) : (
