...
const _3rs4MKUCU1ZPtxx3zKk1 = require('../unmerged_dictionary/dialogs.json');
const _emso5ztL5LEtgAyVnAvX = require('../unmerged_dictionary/export-page.json');
...
const _lzfN07QuLHUaT8WejQ2p = require('../unmerged_dictionary/products.json');
const _vLjzkvo3ktUiH1I3tdDJ = require('../unmerged_dictionary/sales.json');
const _Al4Ns50lqtPpey85S0qa = require('../unmerged_dictionary/settings.json');
const _l13highE9gXwoMiKb99P = require('../unmerged_dictionary/sidebar.json');
